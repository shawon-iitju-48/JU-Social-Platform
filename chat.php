...
// $tme= date('Ymdhis'); 
// echo "<script> console.log($tme)</script>";
?>
  ...
  <div class="wrapper">
    <section class="chat-area">
      <header>
        ...
        ?>
        <button style="border:none;outline:none;background:transparent;margin-right:0.5rem" onclick="history.back()" class="back-icon"><i class="fas fa-arrow-left"></i></button>
        <a style="margin-right:.5rem" href="peopleprofile.php?pi=<?php echo $row['u_id'] ?>"><img src="<?php echo $row['dp']; ?>" alt=""></a>
        <div class="details">
          <a style="color:black;" href="peopleprofile.php?pi=<?php echo $row['u_id'] ?>"><span><?php echo $row['fname'] . " " . $row['lname'] ?></span></a>
          <p><?php echo $row['sstatus']; ?></p>
        </div>
      </header>
      <div class="chat-box">

      </div>
      <form action="#" method="post" class="typing-area" id="fid">
