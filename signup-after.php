...
<head>
    <?php
    $_SESSION['body'] = "Please provide valid email to begin using JU Social and e-Learning Platform. Thank you!";
    ...
    after further verificaton of your provided information. Thank you!";
            $sql = "update user set ustat='yes' where token='$token'";
            mysqli_query($con, $sql);
        } else {
            $ss = "Unsuccessfull";
            $body = "Please provide valid link or token information to begin using JU Social and e-Learning Platform. Thank you!";
        }
    }
    ?>
    <meta charset="UTF-8">
    ...
    <div class="container" style="width:65rem;">
        <div class="activate" style="padding:5rem 0rem;display: <?php if (isset($_GET['email'])) echo "block";
            ...
            <h3 style="text-align:center;padding:2rem 5rem;">We've sent an email to <?php echo $_GET['email']; ?>.
                Click the confirmation link in that email to begin using JU Social and e-Learning Platform.</h3>
            <div class="signup">
        ...
        echo '<button id="jaupakhi" class="btn btn-success" style="width:100%;height:4.2rem; font-weight:500;font-size:2rem;">Please Login...</button>'; ?>
    </div>
    <script>
        $(document).ready(function () {
    $("#jaupakhi").click(function(e) { 
