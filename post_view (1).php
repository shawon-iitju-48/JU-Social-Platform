...
$dp = $dow['dp'];
$pid = $_GET['pidd'];
$q1 = "select *from userpost natural join user natural join userpost_photos where pid='$pid'";
        ...
        <div class="col-9">
            ...
            <div style="margin-top:-3.6rem;position: relative;" id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false" data-bs-interval="false">
                <div class="carousel-inner">
                    ...
                    <img style="object-fit:cover" id="' . $row['photosid'] . '" class="' . $row['pid'] . '" src="' . $row['location'] . '" alt="">
                    </div>';
