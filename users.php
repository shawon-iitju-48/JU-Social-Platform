...
$dp = $dow['dp'];
mysqli_query($con, "update temp set seen='yes' where karconvo='$uid'");
        ...
        <div class="wrapper">
            <section class="users">
                <header>
                    <div class="content">
                        <?php
                        $sql = mysqli_query($conn, "SELECT * FROM user WHERE u_id = {$_SESSION['u_id']}");
                        ...
                        <div class="details">
                            <a style="color:black;text-decoration:none" href="peopleprofile.php?pi=<?php echo $row['u_id'] ?>"><span><?php echo $row['fname'] . " " . $row['lname'] ?></span></a>
                            <p><?php echo $row['sstatus']; ?></p>
                        </div>
                    </div>
                    <a href="groupchat.php" class="btn btn-info">Groups</a>
                </header>
                <div class="search">
