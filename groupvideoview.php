...
$ggg = $_SESSION['gid'];
if (!isset($_GET['pidd']))
    header("Location: group.php?gid=$ggg");
$pid = $_GET['pidd'];
$q1 = "select *from user inner join (select *from grouppost natural join  grouppost_videos where gpid='$pid')x on x.memberid=user.u_id";
...
if (isset($_POST['postupdate'])) {
    ...
    $q2 = "update grouppost set pdetails='$postd' where gpid='$pid'";
    mysqli_query($con, $q2);
...
<nav id="navbar_top" class="navbar navbar-expand-lg navbar-dark bg-white shadow-sm">
    ...
    <div class="row first">
        <div class="col-9">
            <div class="head">
                <div class="left">
                    <button onclick="history.back()" id="backbtn" class="close" style="background:transparent;color:white;outline: none;border:none;margin-left:-1.3rem;margin-top:-2rem;font-size: 3rem;">&times;</button>
                </div>
                <div class="right">
            ...
            <div style="margin-top:-3.6rem;position: relative;" id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false" data-bs-interval="false">
                <div class="carousel-inner">
                    ...
                    <video id="' . $row['videosid'] . '" class="' . $row['gpid'] . '" src="' . $row['location'] . '" width="100%" height="590" controls></video>
                    </div>';
