...
$dp = $dow['dp'];
$pid = $_GET['pidd'];
$q1 = "select *from userpost natural join user where pid='$pid'";
$subres1 = mysqli_query($con, $q1);

if (mysqli_fetch_array(mysqli_query($con, "select *from userpost natural join userpost_photos where pid='$pid'")))
    header("Location: post_view.php?pidd=$pid");
if (mysqli_fetch_array(mysqli_query($con, "select *from userpost natural join userpost_videos where pid='$pid'")))
    header("Location: post_view_video.php?pidd=$pid");
