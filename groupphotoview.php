...
$pid = $_GET['pidd'];
$q1 = "select *from user inner join (select *from grouppost natural join  grouppost_photos where gpid='$pid')x on x.memberid=user.u_id";
        ...
        <div class="col-9">
            ...
            <div style="margin-top:-3.6rem;position: relative;" id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false" data-bs-interval="false">
                <div class="carousel-inner">
                    ...
                    <img style="object-fit:cover" id="' . $row['photosid'] . '" class="' . $row['gpid'] . '" src="' . $row['location'] . '" alt="">
                    </div>';
